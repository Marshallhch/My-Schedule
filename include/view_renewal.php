<div class="categoryTabs">
  ...
  <a href="/myschedule/pages/sch_view.php?key=view_renewal" class="active">Renewal</a>
...
<ul class="boardTable">
  ...
  <?php
            ...
            $sql = "select * from sch_txt where sch_txt_cate = 'renewalProject' order by sch_txt_num desc";
